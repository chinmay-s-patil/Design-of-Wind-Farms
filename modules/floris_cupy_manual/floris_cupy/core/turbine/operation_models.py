...
from floris_cupy.core import BaseClass
...
from floris_cupy.utilities import cosd
    ...
    def thrust_coefficient(
        ...
        **_ # <- Allows other models to accept other keyword arguments
        ...
        thrust_coefficient_interpolator = interp1d(
            to_cpu(power_thrust_table["wind_speed"]),
            to_cpu(power_thrust_table["thrust_coefficient"]),
            fill_value=0.0001,
            bounds_error=False,
        )
        ...
        thrust_coefficient = np.asarray(
            thrust_coefficient_interpolator(to_cpu(rotor_average_velocities))
        )
...
class CosineLossTurbine(BaseOperationModel):
    ...
    def thrust_coefficient(
        ...
        **_ # <- Allows other models to accept other keyword arguments
        ...
        # Construct thrust coefficient interpolant
        thrust_coefficient_interpolator = interp1d(
            np_cpu.asarray(power_thrust_table["wind_speed"].get() if hasattr(power_thrust_table["wind_speed"], 'get') else power_thrust_table["wind_speed"]),
            np_cpu.asarray(power_thrust_table["thrust_coefficient"].get() if hasattr(power_thrust_table["thrust_coefficient"], 'get') else power_thrust_table["thrust_coefficient"]),
            fill_value=0.0001,
            bounds_error=False,
        )
