...
from floris_cupy.core import Core
...
from floris_cupy.utilities import rotate_coordinates_rel_west, wind_delta
...
def plot_rotor_values(
    ...
    Example:
        from floris_cupy.visualization import plot_rotor_values
        plot_rotor_values(floris_cupy.flow_field.u, findex=0, n_rows=1, ncols=4)
        plot_rotor_values(floris_cupy.flow_field.v, findex=0, n_rows=1, ncols=4)
        plot_rotor_values(floris_cupy.flow_field.w, findex=0, n_rows=1, ncols=4, show=True)
    """
...
def calculate_horizontal_plane_with_turbines(
    ...
    findex_for_viz=None,
        ...
        Args:
            fmodel (:py:class:`floris_cupy.floris_model.FlorisModel`):
